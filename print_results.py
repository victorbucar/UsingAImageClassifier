...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """  
    print("\n**Results from print_result**\n")
    
    print("CNN Model being used: ", model)
    
    print("\nNumber of images: ", len(results_dic))
    print("\nNumber of dog images: ", results_stats_dic["n_dogs_img"])
    print("\nNumber of not a dog images: ", results_stats_dic["n_notdogs_img"])
    
    ## Print statistics
    print("Printing statistics of the classification algorithm\n ")
    ...
    ## Print misclassfications based on variable
    if print_incorrect_dogs and results_stats_dic["n_dogs_img"] + results_stats_dic["n_notdogs_img"] != results_stats_dic["n_images"]:
        ...
        for key in results_dic:
            if sum(results_dic[key][3:]) == 1: ## smart check same as if results_dic[key][3] == 1 and results_dic[key][4] == 0
                print("Pet image: ", results_dic[key][0])
                print("Classifier label: ", results_dic[key][1])
                print("Match image and classifier label key[2]: ", results_dic[key][2])
                print("is-a_dog/ is_not_a_god key[3]: ", results_dic[key][3])
                print("Classifier classified as dog or not a dog key[4]: ", results_dic[key][4])
    ...
    if print_incorrect_breed and results_stats_dic["n_dogs_img"] != results_stats_dic["n_correct_breed"]:
        ...
        for key in results_dic:
            ...
            if (sum(results_dic[key][3:]) == 2 and ## smart check same as if results_dic[key][3] == 1 and results_dic[key][4] == 1
                results_dic[key][2] == 0 ):
                print("Real: {:>26}   Classifier: {:>30}".format(results_dic[key][0],
                                                          results_dic[key][1]))
                print("Printing check 1: ", sum(results_dic[key][3:]))
                print("Printing check 1: ", results_dic[key][3])
                print("Printing results_dic[key][2]: ", results_dic[key][2])
